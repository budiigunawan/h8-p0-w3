...
var nomor_ktp = '1234567890' //silahkan berikan nilai bebas
...
if (name == '') {
    ...
    if (nomor_ktp.length > 4 && nomor_ktp !== '') {
        if (alamat === 'Jakarta' || alamat === 'Bandung' || alamat === 'Surabaya' || alamat === 'Yogyakarta') {
            switch (alamat) {
                case 'Jakarta' :
                    hargaDasar = 100000;
                    break;
            ...
            if (jenis_rumah === 'normal' || jenis_rumah === 'large') {
                ...
                var totalBiaya = hargaDasar + biayaRumah;
